...
# 투게더(Together) Design System

투게더는 팀 피크에서 프로덕트 개발에 있어서 개발생산력을 울리기 위해 개발된 디자인 시스템이에요.
편의성과, 자율성을 고려하여 개발자의 DX를 최대한 향상시키위해 노력하고 있어요.
